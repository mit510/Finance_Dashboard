        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              ...
              <button className="absolute bottom-0 right-0 p-2 bg-white dark:bg-neutral-700 rounded-full shadow-lg border-2 border-white dark:border-neutral-600 hover:scale-110 transition-transform">
